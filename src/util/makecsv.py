        ...
        for child in node['children']:
            ...
            if "children" in child:
                ...
                try:
                    ...
                    ID=child.get("d3f:d3fend-id", "")
                    lines.append([ID, tactic, child['rdfs:label'], child['d3f:definition'], depth])
...
with open("build/d3fend.csv", "w") as f:
    ...
    #             0                1                   2                           3                           4
    fieldnames = ["ID", "D3FEND Tactic", "D3FEND Technique", "D3FEND Technique Level 0", "D3FEND Technique Level 1", "Definition"]
